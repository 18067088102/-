<template>
	<view class="u-char-box">
		<view class="u-char-flex">
			<input :disabled="disabledKeyboard" :value="valueModel" :focus="focus" :maxlength="maxlength" class="u-input" @input="getVal"
			 @click="showBoard" />
			<view v-for="(item, index) in loopCharArr" :key="index" :style="index==2?'margin-left: 50rpx;':''">
